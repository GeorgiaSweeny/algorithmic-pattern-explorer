...
- **`pattern/`** — Composition logic. Nodes that describe how generated/computed structures are arranged or composed into a final pattern: `radial-divisions`, `edge-deformation`, `subdivide`.
